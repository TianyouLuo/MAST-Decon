...
STdir = "/pine/scr/t/i/tianyou/ST/mouse_brain_cell2location/data/ST/ST8059052/"
...
annotation = fread(file.path(STdir, "annotation/ST8059052_markers_layers.csv"))
annotation = annotation[annotation$ST8059052 != ""]
...
write.table(cnt_t, file.path(STdir, "ST8059052_processed.tsv"),row.names=T,col.names=T,sep="\t",quote=F)
